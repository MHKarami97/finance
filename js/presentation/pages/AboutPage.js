  ...
  render() {
    ...
    content.innerHTML = `
      <section class="about-card">
        ...
        <p>
          یک اپلیکیشن وب پیشرو برای مدیریت دخل و خرج شخصی، طراحی‌شده برای کار کاملاً آفلاین.
          تمام اطلاعات شما فقط در سیستم خودتان ذخیره می‌شود و هیچ داده‌ای
      ...
      <section class="about-card about-card--developer">
        ...
        <p class="dev-role">توسعه‌دهنده نرم‌افزار</p>
